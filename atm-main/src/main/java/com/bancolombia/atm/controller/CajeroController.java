...
import com.bancolombia.atm.dto.TransferenciaForm;
...
import com.bancolombia.atm.services.MovimientoService;
import com.bancolombia.atm.services.RetiroService;
...
public class CajeroController {
    ...
    public String login(@RequestParam String numeroCuenta,
        ...
        if (cliente == null) {
            model.addAttribute("error", "La cuenta no tiene cliente asociado.");
            return "cajero/login";
        }
